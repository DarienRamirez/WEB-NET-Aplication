<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="type_register.aspx.cs" Inherits="WEB_NET_Aplication.type_register" enableEventValidation="false"%>
        ...
        <main>
          ...
          <section class="section card mb-5">
            <div class="card text-center">
              <h3 class="card-header danger white-text">Registro de Tipo</h3>
            <div class="card-body">
              <div class="row">
         ...
         <div class="modal fade" id="modal_view" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
          <div class="modal-dialog cascading-modal" role="document">
            ...
            <div class="modal-content">
              <div class="modal-c-tabs">
                  <div class="tab-pane fade in show active mt-4 ml-4">
                      <h4><strong>Informacion de Tipo</strong></h4>
                    <div class="modal-body mb-1">
                      <div class="md-form form-sm">
